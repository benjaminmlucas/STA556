...
high_scores = ... # a list of scores >= 90
older_ids = ... # a list of IDs of people aged >=35
groups = ... # a list of group (see if you can make this a set!)
score_by_id = ... # a dictionary with ID as the key and score as the value
```
